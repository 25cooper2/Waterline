  ...
  return (
    <div className="screen" style={{ position: 'relative' }}>
      <MapContainer center={mapCenter} zoom={initialZoom} style={{ flex: 1, width: '100%', minHeight: 0, height: '100%' }} zoomControl={false}>
        ...
        {/* Waterway lines — rendered in overlayPane (z-index 400, behind all markers)
            with full opacity for solid teal lines. */}
        {waterwayLines.map(wl => (
          <Polyline key={wl.id} positions={wl.coords} pane="overlayPane"
