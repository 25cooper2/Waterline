...
export const api = {
  ...
  adminBoats: () => req('/api/admin/boats'),
  adminHazards: () => req('/api/admin/hazards'),
  adminLogbooks: () => req('/api/admin/logbooks'),
  ...
  adminUpdateListing: (id, body) => req(`/api/admin/listings/${id}`, { method: 'PUT', body: JSON.stringify(body) }),
  ...
  adminDeleteLogbook: (id) => req(`/api/admin/logbooks/${id}`, { method: 'DELETE' }),
